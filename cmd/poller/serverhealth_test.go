...
func dataVol(pct float64, free uint64) alerts.ServerVolume {
	return alerts.ServerVolume{Label: "data", Volume: serverhealth.Volume{Path: "/data", Percent: pct, FreeBytes: free}}
}
...
func TestRecordServerMetrics_DataOKPopulatesDataDiskFields(t *testing.T) {
	...
	p.recordServerMetrics([]alerts.ServerVolume{rootVol(60, 100), dataVol(42, 7<<30)}, true)
...
func TestRecordServerMetrics_DataNotOKLeavesDataDiskFieldsNil(t *testing.T) {
	...
	p.recordServerMetrics([]alerts.ServerVolume{rootVol(60, 100), dataVol(99, 1)}, false)

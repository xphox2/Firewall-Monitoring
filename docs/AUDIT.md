...
2026-06-02 — AUDIT-022 — CSP nonce for inline scripts/styles (per-request 128-bit, no more unsafe-inline) — v0.10.259 — (pending) — opencode
```

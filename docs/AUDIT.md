...
2026-06-02 — AUDIT-145 — parseBucketToMillis returns -1 sentinel (not 0) for unparseable, chart no longer renders 1970 — v0.10.274 — (pending) — opencode
```

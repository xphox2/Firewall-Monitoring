...
2026-06-02 — AUDIT-146 — EnsurePartitions skip-message now uses WARNING: AUDIT-146 prefix (grep-able) — v0.10.289 — (pending) — opencode
```

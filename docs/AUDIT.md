...
2026-06-02 — AUDIT-029 — interface_errors, processor_stats, process_stats, irc_message_logs now in CleanupOldData — v0.10.277 — (pending) — opencode
```

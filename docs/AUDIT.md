...
2026-06-02 — AUDIT-139 — static.go doc block names the lack-of-minification + esbuild migration path — v0.10.284 — (pending) — opencode
```

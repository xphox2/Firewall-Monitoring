...
2026-06-02 — AUDIT-154/155/156 — WONTFIX (audit was wrong: ParseHours / FilterAllowedFields / validVendors are all used) — v0.10.281 — (pending) — opencode
```

...
2026-06-05 — AUDIT-017 — hash probe registration keys at rest (sha256, show-once, live-probe-safe migration) — v0.10.329 — (pending) — opencode
```

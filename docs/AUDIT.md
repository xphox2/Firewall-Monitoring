...
2026-06-02 — AUDIT-158 — getDefaultPassword no longer caches in module-level var (password didn't linger in GC) — v0.10.292 — (pending) — opencode
```

...
2026-06-02 — AUDIT-115 — AI agent session-memory files (lessons.md, tasks/) removed from public tree — v0.10.275 — (pending) — opencode
```

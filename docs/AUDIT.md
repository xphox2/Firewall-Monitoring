...
2026-06-05 — AUDIT-018 — bump gin/jwt/gosnmp/x-net (conservative, keep go1.23); defer go-ircevent + stdlib toolchain — v0.10.328 — (pending) — opencode
```

...
2026-06-05 — AUDIT-085 — wrap probe key rotation in a transaction (generate-first, rollback-safe) — v0.10.325 — (pending) — opencode
2026-06-05 — AUDIT-020 — SSRF: pinned SafeDialContext + widen block list (CGNAT/0.0.0.0/8/multicast) — v0.10.326 — (pending) — opencode
```

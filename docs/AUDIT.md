...
2026-06-02 — AUDIT-151 — fwmonLog wrapper introduced (admin-common.js migrated; ~100 calls in 8 other files deferred) — v0.10.286 — (pending) — opencode
```

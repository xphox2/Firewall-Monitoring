...
2026-06-06 — AUDIT-038 — batched retention deletes (10k LIMIT, PG lock_timeout, 100ms sleep) — v0.10.331 — (pending) — opencode
2026-06-06 — AUDIT-043 — verify window-chart queries SQLite-safe + regression test (no gating) — v0.10.332 — (pending) — opencode
```

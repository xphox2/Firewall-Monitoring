...
2026-06-02 — AUDIT-127 — admin-controls.js back-button limitation documented in source (router upgrade path noted) — v0.10.276 — (pending) — opencode
```

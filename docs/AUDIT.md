...
2026-06-02 — AUDIT-133 — formatBytes(NaN) returns em-dash "no data" marker instead of "NaN.0 undefined" — v0.10.273 — (pending) — opencode
```

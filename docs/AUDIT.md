...
2026-06-02 — AUDIT-149 — GORM log level is no longer hardcoded to Silent (DB_LOG_LEVEL=warn default) — v0.10.285 — (pending) — opencode
```

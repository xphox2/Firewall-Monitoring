...
2026-06-02 — AUDIT-093 — Postgres password auto-generated, persisted to /config/pg-credentials (chmod 0600) — v0.10.265 — (pending) — opencode
```

...
2026-06-02 — AUDIT-096 — docker-compose.yml has explicit healthcheck block (mirrors Dockerfile v0.10.264) — v0.10.266 — (pending) — opencode
```

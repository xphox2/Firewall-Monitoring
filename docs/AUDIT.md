...
2026-06-02 — AUDIT-138 — URL-rewrite prefix-collision documented (hand-coded, fragile; upgrade via AUDIT-090) — v0.10.283 — (pending) — opencode
```

...
2026-06-02 — AUDIT-169 — cmd/api/static.go layering decision documented in source (audit accepts as-is) — v0.10.272 — (pending) — opencode
```
